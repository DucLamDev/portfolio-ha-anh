    ...
    <main className="min-h-screen" style={{ background: 'linear-gradient(180deg, #3d0066 0%, #1a0033 50%, #0d001a 100%)' }}>
      ...
      <section className="pt-28 pb-16 relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-4">
          <h1 className="metal-heading-xl text-brand-green mb-10 animate-scale-in">ABOUT ME</h1>
          
          <div className="grid md:grid-cols-[1.5fr,1fr] gap-8 items-center">
            <div className="text-sm md:text-base leading-relaxed text-white space-y-4 text-left animate-fade-in animate-delay-200">
              <p>
            ...
            <div className="hidden md:block relative w-full h-[500px] animate-fade-in shadow-2xl" style={{ filter: 'drop-shadow(0 10px 40px rgba(0, 0, 0, 0.8))' }}>
      ...
      <section className="py-16 relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="metal-heading-xl text-brand-green text-center mb-8 animate-slide-up">TIME</h2>
          
          <div className="max-w-4xl mx-auto text-sm md:text-base leading-relaxed text-white mb-10 text-left animate-fade-in animate-delay-200">
            <p>
      ...
      <section className="py-16 relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="metal-heading-xl text-brand-green text-center mb-8 animate-slide-up">1(5)7</h2>
          
          <div className="max-w-4xl mx-auto text-sm md:text-base leading-relaxed text-white mb-10 text-center animate-fade-in animate-delay-200">
            <p>
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-[1.2fr,0.8fr] gap-6 mb-6">
              <div className="relative min-h-[500px] md:min-h-[600px] animate-slide-left hover-lift border-2 border-brand-green">
                <Image src="/about/about_5.jpg" alt="1(5)7 main guitar" fill className="object-cover" />
              </div>
              
              {/* Right side images */}
              <div className="grid grid-cols-2 gap-4">
                <div className="relative min-h-[280px] animate-scale-in animate-delay-200 hover-lift border-2 border-white">
                  <Image src="/about/about_6.jpg" alt="1(5)7 close up" fill className="object-cover" />
                </div>
                <div className="relative min-h-[280px] animate-scale-in animate-delay-300 hover-lift border-2 border-brand-green">
                  <Image src="/about/about_7.jpg" alt="1(5)7 detail" fill className="object-cover" />
                </div>
                <div className="relative min-h-[280px] col-span-2 animate-scale-in animate-delay-400 hover-lift border-2 border-white">
      ...
      <section className="py-16 relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="metal-heading-xl text-brand-green text-center mb-8 animate-slide-up">IMPROVISE</h2>
      ...
      <section className="py-16 relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="metal-heading-xl text-brand-green text-center mb-8 animate-slide-up">WITCH HUNT</h2>
      ...
      <section className="py-16 relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="metal-heading-xl text-brand-green text-center mb-8 animate-slide-up">DARK HORSE</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            {/* Large right image */}
            <div className="relative min-h-[500px] md:min-h-[600px] animate-slide-right hover-lift border-2 border-white">
