    ...
    <main className="relative bg-brand-purple min-h-screen">
      ...
      <section className="pt-28 pb-20 text-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          {/* Gold Prize - ITE */}
          <div className="mb-16 animate-slide-up animate-delay-300 text-center">
          ...
          <div className="mb-16 animate-slide-up animate-delay-400 text-center">
            <h2 className="text-brand-green font-bold text-xl md:text-2xl mb-6">
          ...
          <div className="mb-16 animate-slide-up animate-delay-500 text-center">
            <h2 className="text-brand-green font-bold text-xl md:text-2xl mb-6">
          ...
          <div className="mb-16 animate-slide-up animate-delay-600 text-center">
            <h2 className="text-brand-green font-bold text-xl md:text-2xl mb-6">
          ...
          <div className="mb-16 animate-slide-up animate-delay-700 text-center">
            <h2 className="text-brand-green font-bold text-xl md:text-2xl mb-6">
              Consolation Prize - &quot;Spreading Positive Energy&quot; Contest, Tuoi Tre Online (5th Edition)
            </h2>
            <div className="flex justify-center mb-6">
              <div className="bg-white p-4 shadow-xl inline-block max-w-[500px] hover-lift">
                <Image
